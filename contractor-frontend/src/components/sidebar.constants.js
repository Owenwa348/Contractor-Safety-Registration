...
export const MENU_ITEMS = [
  { name: 'จัดการรายชื่อพนักงานตามสังกัด', path: '/manage-team', step: 1, icon: 'UsersIcon' },//เห็นแค่ผู้รับเหมา
  { name: 'รายชื่อพนักงานตามสังกัด', path: '/list-employees', icon: 'DocumentTextIcon' },//เห็นเฉพาะSafety
