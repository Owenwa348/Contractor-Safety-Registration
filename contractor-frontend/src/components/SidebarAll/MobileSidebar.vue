...
export default {
  ...
  methods: {
    ...
    getMenuDescription(path) {
      const descriptions = {
        '/manage-team': 'จัดการข้อมูลพนักงาน',
        '/training-booking': 'จองคิวอบรม',
        '/book-training': 'เลือกหลักสูตร',
        '/take-exam': 'ทำแบบทดสอบ',
        '/approval-officer': 'อนุมัติเอกสาร',
        '/approval-safety': 'ตรวจสอบความปลอดภัย',
        '/print-card': 'พิมพ์บัตรประจำตัว',
        '/create-training': 'สร้างหลักสูตรใหม่',
        '/setting': 'ตั้งค่าระบบ',
        '/list-employees': 'รายชื่อทั้งหมด',
        '/download-training-list': 'ดาวน์โหลดรายงาน'
      };
